...
export const cards: IProjectProp[] = [
  {
    ...
    image: "/thumbnails/base-blue.webp",
    alt: "blueArt",
  ...
  },
  {
    ...
    image: "/thumbnails/generative-art.webp",
    alt: "Generative Art",
    github: "",
  ...
  },
  {
    ...
    image: "/thumbnails/searshape.webp",
    alt: "SearShape",
...
export const cardsDesign: IProjectProp[] = [
  {
    ...
    image: "/thumbnails/drawings.webp",
    alt: "Drawings",
    github: "",
  ...
  },
  {
    ...
    image: "/thumbnails/logo-design.png",
    alt: "Logo Design",
    github: "",
  ...
  },
  {
    ...
    title: "this.Portfolio",
    tags: ["Blender", "Rive"],
    description: "I wanted to show what kind of environment I love, adding some fantasy with a Maple tree connected to a monitor, which will display a representation of himself as a moving leaf on the screen, animated with Rive. ",
    image: "/thumbnails/this-portfolio-design.webp",
    alt: "this.Portfolio",
    github: "https://github.com/TheoHiwo/portfolio",
    live: "",
  },
