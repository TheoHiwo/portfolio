...
export default function FindyShape() {
  return (
    <>
      <toScreen.In>
        <div className="main-content content z-0 flex-col py-12 px-5 w-full justify-center items-center text-secondary bg-primary touch-pan-y m-auto">
          ...
          <div className="text-center tracking-widest text-4xl pb-5">
          ...
          <div className="text-2xl justify-normal">
            ...
            <p>
              ...
              identifiable information, including but not limited to nicknames, ip adress. The information that I
            ...
            <p>
              ...
              <a
                href={`mailto:contact-games@theo-berraboukh.com`}
                draggable="false"
                className="text-decoration-line: underline"
              >
                contact-games@theo-berraboukh.com.
              </a>
            </p>{" "}
            <p>
