  ...
  return (
    <toScreen.In>
      <main className="z-0 flex-col py-12 px-5  w-full justify-center items-center text-secondary bg-primary touch-pan-y  m-auto">
        ...
        <div className="h-1/4 w-1/2 m-auto text-center">
          <EyeTrack />
        </div>
          <div className="text-center tracking-widest text-4xl pb-5"><strong>Privacy Policy</strong></div>{" "}
        <div className="text-2xl justify-normal">
          <p>
            Hiwoyn built the Findy Shape app as a Free app. This SERVICE is provided by Hiwoyn at no cost and is
          ...
          <p>
            ...
            accessible at Findy Shape unless otherwise defined in this Privacy Policy.
          </p>{" "}
          <p>
          ...
          <p>
            ...
            identifiable information, including but not limited to nicknames, ip adress. The information that I request
            will be retained on your device and is not collected by me in any way.
          </p>{" "}
          <div>
            <p>The app does use third-party services that may collect information used to identify you.</p>{" "}
            <p>Link to the privacy policy of third-party service providers used by the app:</p>{" "}
            <ul className="text-decoration-line: underline" draggable="false">
              <li >
          ...
          <p>This policy is effective as of 2023-07-26</p>{" "}
          <p>
            <strong>Contact Us</strong>
          </p>{" "}
          <p>
            If you have any questions or suggestions about my Privacy Policy, do not hesitate to contact me at{" "}
            <a href={`mailto:contact-games@theo-berraboukh.com`} draggable="false" className="text-decoration-line: underline">contact-games@theo-berraboukh.com.</a>
          </p>{" "}
          <p>
            This privacy policy page was created at{" "}
            <a href="https://privacypolicytemplate.net" target="_blank" rel="noopener noreferrer" className="text-decoration-line: underline" draggable="false">
              privacypolicytemplate.net{" "}
            </a>
            and modified/generated by{" "}
            <a href="https://app-privacy-policy-generator.nisrulz.com/" target="_blank" rel="noopener noreferrer" className="text-decoration-line: underline" draggable="false">
